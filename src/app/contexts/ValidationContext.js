  ...
  switch (action.type) {
    ...
    case "SECURITY_VALIDATED":
      return {
        ...
        security: {
          status: "complete",
          criticalIssues: action.payload.criticalIssues,
          highIssues: action.payload.highIssues,
          mediumIssues: action.payload.mediumIssues,
          lowIssues: action.payload.lowIssues,
          hasSecurity: action.payload.hasSecurity,
        },
      };
...
export function ValidationProvider({ children }) {
  ...
  const value = {
    ...
    setLevelResult: (levelData) => {
      dispatch({ type: "LEVEL_DETECTED", payload: levelData });
    },
    setStructureResult: (issues, recommendations, valid) => {
      dispatch({
        type: "STRUCTURE_VALIDATED",
        payload: { issues, recommendations, valid },
      });
    },
