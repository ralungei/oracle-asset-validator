...
const FancyButton = ({
  ...
  return (
    <Box
      ...
      sx={{
        position: "relative",
        padding: "6px 10px 6px 14px", // Usar padding para controlar el tamaño
        borderRadius: "24px",
        border: "none",
        overflow: "hidden",
        display: "inline-flex", // Cambiar a inline-flex para ajustarse al contenido
        alignItems: "center",
        justifyContent: "center",
        cursor: disabled ? "not-allowed" : "pointer",
        backgroundColor: "#fff",
        boxShadow: "0 2px 10px rgba(0,0,0,0.05)",
        transition: "border-radius 0.15s ease, box-shadow 0.15s ease", // Faster transitions
        "&:hover": {
        ...
        <AnimatePresence mode="wait">
          {!isHovered || disabled ? (
            ...
            >
              ...
              >
                <ArrowForwardIcon
                  sx={{ fontSize: 16, color: "#fff", mt: "1px" }}
                />
              </Box>
            </Box>
          )}
